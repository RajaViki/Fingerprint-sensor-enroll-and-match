...
#define ACK 0x01		//Acknowledgement packet to be received (default)
#define DATA 0x02		//Data packet to be received

#define BAUD_RATE 4 	// takes values from 1 - 12
#define SEC_LEVEL 5		// takes values from 1 - 5
#define PACK_LEN 6		// takes values from 0 - 3
...
class Adafruit_Fingerprint {
 public:
  ...
  uint16_t getReply(uint8_t packet[], uint8_t type=ACK, uint16_t timeout=DEFAULTTIMEOUT);
